<?php
// jahanbots مرجع بروز ترین سورس ها و ربات های تلگرامی
// نویسنده انواع ربات در تلگرام
// @jahanbots هم اکنون به ما بپیوندید
ob_start();
define('API_KEY','6586687695:AAE-bBPJjzWqXDUHc4Kdn2fxgZuUZZfPTBw'); // توکن رباتتان را بگذارید
//-----------------------------------------------------------------------------------------
//فانکشن jijibot :
...
//متغیر ها :
// msg
$Dev = array("6770175547", "5709152459"); // put id of admins
...
else
{
 golddev('answercallbackquery', [
            'callback_query_id' =>$membercall,
            'text' => "🎉 تبریک 30 تا سکه هدیه گرفتی 🎉",
            'show_alert' =>false
        ]);
$coin = $cuser["userfild"]["$fromid"]["coin"];
$pluscoin = $coin + 30;
...
elseif($data=="bycoin"){
     ...
     'message_id'=>$messageid,
               ...
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   				   [
['text'=>"غیرفعال",'url'=>"t.me/jahanbots"],['text'=>"غیرفعال",'url'=>"t.me/jahanbots"]
				   ],
				   [
['text'=>"🔙 برگشت",'callback_data'=>'panel']
				   ],
